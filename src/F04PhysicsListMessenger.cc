...
{
    delete SRTypeCmd;//Add hiromi 2009/08/12
...
//Hiromi Add 2009/08/12
  if (command == SRTypeCmd)
    { fPhysicsList->SetAnalyticSR(SRTypeCmd->GetNewBoolValue(newValue));} 
//END Hiromi Add 2009/08/12
